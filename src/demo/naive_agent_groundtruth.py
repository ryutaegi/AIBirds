    ...
    def run(self):
        ...
        while True:
            ...
            if state == GameState.WON:
                ...
                novelty_level = 0
                novelty_description = "";
                hierarchy_report = [0.00,0.11,0.22,0.33,0.44,0.55,0.66,0.77,0.88]
                self.ar.report_novelty_likelihood(novelty_likelihood,non_novelty_likelihood,novel_obj_ids,novelty_level,novelty_description,hierarchy_report)
